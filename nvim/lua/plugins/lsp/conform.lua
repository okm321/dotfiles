    ...
    config = function()
        ...
        conform.setup({
            ...
            format_on_save = function(bufnr)
                ...
                local function detect_formatters(ft)
                    ...
                    -- ESLintの設定ファイルを探す
                    local eslint_config = find_config_file(".eslintrc.js") or
                        find_config_file(".eslintrc.json") or
                        find_config_file(".eslintrc.yml") or
                        find_config_file(".eslintrc")
                    ...
                    if eslint_config then
                        if ft:match("typescript") or ft:match("javascript") or ft == "vue" then
                            ...
                            -- Prettierの設定ファイルを探す
                            local prettier_config = find_config_file(".prettierrc") or
                                find_config_file(".prettierrc.js") or
                                find_config_file(".prettierrc.json") or
                                find_config_file(".prettierrc.yaml") or
                                find_config_file(".prettierrc.yml") or
                                find_config_file(".prettier.config.js")
        ...
        vim.api.nvim_create_user_command("FormatDebug", function()
            ...
            if ft:match("javascript") or ft:match("typescript") or ft == "vue" or ft == "json" then
                ...
                local prettier_path = find_config_file(".prettierrc") or
                    find_config_file(".prettierrc.js") or
                    find_config_file(".prettierrc.json") or
                    find_config_file(".prettier.config.js") or "not found"
